...
//quoteScript.src = "catQuote.js";
//bd.appendChild(quoteScript); */ 



//var para = document.createElement("h3");

//var text = "\"It is always the simple that produces the marvelous.\" – Amelia Barr";

//para.innerHTML = text; 


var catBox = document.createElement("div");
catBox.style.background = "url('http://etverse.com/web-app-demo/a/fly-cat.gif')";
 // catBox.style.background = "url('fly-cat.gif')";


var quoteTextTarget = document.createElement("p");
quoteTextTarget.setAttribute("id", "quote");
quoteTextTarget.setAttribute("class", "fade-in");
quoteTextTarget.innerHTML = quoteAsText; 
quoteTextTarget.style = "font-size: 1.2rem";
   


//quoteText.innerHTML = "\"It is always the simple that produces the marvelous.\"";

var quoteAuthorTarget = document.createElement("p");
quoteAuthorTarget.setAttribute("id", "author");
quoteAuthorTarget.innerHTML = " – " + authorAsText; 
 quoteAuthorTarget.style = "font-weight: bold; text-indent: 50px; ";

//quoteAuthor.innerHTML = "  – TEXT HARDCODED AND SET IN CONTENT.JS"


quoteBox = document.createElement("div");
quoteBox.setAttribute("id","quoteBox");
quoteBox.style.display =  "inline-block";
quoteBox.prepend(quoteAuthorTarget);
quoteBox.prepend(quoteTextTarget);
quoteBox.style.padding = "7px";
quoteBox.style.paddingTop = "50px";
quoteBox.style = "font-family: arial black";

//catBox.prepend(quoteBox);



/* Close button did not work do to Chrome policy restrictions. 
var closeButton = document.createElement("span"); 
closeButton.setAttribute("id","closeButton");
closeButton.innerHTML = "&times;";
closeButton.border = "gray solid 2px";

catBox.prepend(closeButton);
*/

//event listener function since inline javascript is not allowed in chrome extensions. 
//document.addEventListener('DOMContentLoaded', function() {
  //  var closer = document.getElementById('closeButton');
    // onClick's logic below:
    //setTimeout(closeTheBox, 8000);

    
    //closer.addEventListener('click', function() {
        
        //box = document.getElementsByTagName("div")[0];
      //  box = document.getElementById("catBox");
...
catBox.style.opacity = "0.5";

catBox.setAttribute("class", "fade-in");
catBox.style.height= "240px";


catBox.style.fontWeight = "bold";
catBox.style.fontVariant = "small-caps";

bd.prepend(catBox);
//catBox.style.fontSize = "2rem";



catBox.style.margin = "4px";
catBox.style.padding = "4px";
catBox.style.textShadow = "#05c996d6 2px 1px 2px, rgba(255, 172, 0, 0.68) 4px 4px 4px";
catBox.getElementsByTagName("p")[1].style = " padding-left: 10px; text-size: .8 rem"; 

 var meowO = new Audio();
meowO.src ='http://etverse.com/web-app-demo/a/meow-off.wav';
    setTimeout(closeTheBox, 15000);

//END brace and semlicolon for WINDOW.ONLOAD >> Still not sure if this will be needed. 
//};

 //  END  OF ALL CONTENT PREVIOUSLY IN CONTENT DOT JS FILE ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ



  //Load quote body to targeted elm

  
/* ALTERNATE CODE TO SET QUOTE TEXT AND ADD TO PAGE: 

 var quote = document.createElement("p");
      quote.innerHTML =  res.body.quote.body;
      var target1 = document.getElementById("quote");
     

    //load quote author to targeted elm
    
  var para = document.createElement("p");
      para.innerHTML = " – " + res.body.quote.author;
      var target2 = document.getElementById("author");
...
});  //end of code that retrieves api. 
...
function closeTheBox() { 
 ...
 box = document.getElementById("catBox"); 
    ...
    var meowOff = new Audio();
meowOff.src ='http://etverse.com/web-app-demo/a/meow-off.wav';

meowOff.play();

box.setAttribute("class","m-fadeOut");

setTimeout(removeTheBox, 800);
...
document.getElementById("catBox").remove();
